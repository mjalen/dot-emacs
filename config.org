...
I used to use Helm, but it doesn't really work well with god-mode and was giving me RSI. So I am using vertico now since I can enter god-mode from within it :) I may or may not add more completion packages (orderless for example) as the need arises.
